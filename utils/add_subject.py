...
def get_curriculum_data() -> Dict:
    ...
    curriculum_path = os.path.join(
        ...
        "data", "curriculum", "BIT_AI_K18B-18C.json"
    )
...
def add_subject(subject_code: str, name: str = None, data_file: str = None) -> Optional[Subject]:
